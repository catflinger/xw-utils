...
describe('TokeniserService', () => {
    ...
    it('should parse simple text', () => {
        ...
        expect(tokens[0].type).toEqual(parseTokenTypes.AcrossMarker);
        expect(tokens[1].type).toEqual(parseTokenTypes.Clue);
        expect(tokens[2].type).toEqual(parseTokenTypes.DownMarker);
        expect(tokens[3].type).toEqual(parseTokenTypes.Clue);
        expect(tokens[3].type).toEqual(parseTokenTypes.Clue);
    });
    ...
    it('should parse with preamble', () => {
        ...
        expect(tokens[2].type).toEqual(parseTokenTypes.AcrossMarker);
        expect(tokens[4].type).toEqual(parseTokenTypes.DownMarker);
    ...
    it('should parse split text', () => {
        ...
        expect(tokens[0].type).toEqual(parseTokenTypes.AcrossMarker);
        expect(tokens[1].type).toEqual(parseTokenTypes.Clue);
        expect(tokens[2].type).toEqual(parseTokenTypes.ClueStart);
        expect(tokens[3].type).toEqual(parseTokenTypes.ClueEnd);
        expect(tokens[6].type).toEqual(parseTokenTypes.ClueStart);
        expect(tokens[7].type).toEqual(parseTokenTypes.Text);
        expect(tokens[8].type).toEqual(parseTokenTypes.ClueEnd);
    });
